...
var getUser = service_1.userService.getUser, getUsers = service_1.userService.getUsers, createUser = service_1.userService.createUser, loginUser = service_1.userService.loginUser;
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        error_1 = _a.sent();
                        return [2 /*return*/, res.status(400).json({ error: "Users not found" })];
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        token = _a.sent();
                        return [2 /*return*/, res.header("authtoken", token).status(200).json("Login successful")];
                    case 2:
                        error_4 = _a.sent();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, model_1.default.findByIdAndDelete(req.params.id)];
                    case 1:
                        user = _a.sent();
                        return [2 /*return*/, res.status(200).json(user)];
                    case 2:
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, model_1.default.findByIdAndUpdate(req.params.id, req.body, {
                                new: true,
                            })];
                    case 1:
                        user = _a.sent();
