...
var UserDao = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, model_1.default.findById(userId)];
                    case 1:
                        user = _a.sent();
    ...
    UserDao.prototype.getUserByMail = function (email) {
        return __awaiter(this, void 0, void 0, function () {
            var user, error_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, model_1.default.create(user)];
                    case 1:
                        newUser = _a.sent();
    ...
    UserDao.prototype.editUser = function (userId, user) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, model_1.default.findByIdAndUpdate(userId, user, {
                                new: true,
                            })];
                    case 1:
                        updatedUser = _a.sent();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, model_1.default.findByIdAndDelete(userId)];
                    case 1:
                        deletedUser = _a.sent();
                        return [2 /*return*/, deletedUser];
                    case 2:
                        error_6 = _a.sent();
                        throw Error(error_6.message);
                    case 3: return [2 /*return*/];
                }
            });
        });
